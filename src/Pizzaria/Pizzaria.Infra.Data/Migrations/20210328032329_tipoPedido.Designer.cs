...
namespace Pizzaria.Infra.Data.Migrations
{
    ...
    [Migration("20210328032329_tipoPedido")]
    partial class tipoPedido
    {
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Categoria", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        ...
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 786, DateTimeKind.Local).AddTicks(194));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 820, DateTimeKind.Local).AddTicks(524));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Endereco", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 824, DateTimeKind.Local).AddTicks(210));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 825, DateTimeKind.Local).AddTicks(5618));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.TipoPedido", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 827, DateTimeKind.Local).AddTicks(1558));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 28, 0, 23, 28, 778, DateTimeKind.Local).AddTicks(7585));
