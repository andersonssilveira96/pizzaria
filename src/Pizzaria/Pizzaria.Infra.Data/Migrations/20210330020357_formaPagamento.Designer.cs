...
namespace Pizzaria.Infra.Data.Migrations
{
    ...
    [Migration("20210330020357_formaPagamento")]
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Categoria", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        ...
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 959, DateTimeKind.Local).AddTicks(8302));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 988, DateTimeKind.Local).AddTicks(6201));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Endereco", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 992, DateTimeKind.Local).AddTicks(3016));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.FormaPagamento", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 993, DateTimeKind.Local).AddTicks(6956));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Produto", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 995, DateTimeKind.Local).AddTicks(279));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.TipoPedido", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 996, DateTimeKind.Local).AddTicks(4210));
            ...
            modelBuilder.Entity("Pizzaria.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime>("DataInclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 3, 29, 23, 3, 56, 955, DateTimeKind.Local).AddTicks(7817));
